<p align="center">
  <img src="https://raw.githubusercontent.com/mhadifilms/pmr/main/docs/assets/logo.svg" alt="pmr logo" width="140">
</p>
...
`pmr` is a command-line tool, a typed Python library, and a [Model Context Protocol (MCP)](docs/mcp.md) server for automating **Adobe Premiere Pro** — editing, sequencing, effects, and export. It drives Premiere's UXP API through a bundled bridge plugin, wraps it in clean idempotent operations with structured JSON output, and makes it usable by humans, scripts, and AI agents (Claude, Cursor, and any MCP-compatible client).
