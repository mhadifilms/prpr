...
:class:`~pmr.errors.NotSupportedError` — same routing, clear failure.
"""
...
def status(ctx: typer.Context) -> None:
    ...
    raise errors.NotSupportedError(
        ...
        fix="Use `pmr render submit --wait` or stream events with `pmr render watch`.",
    )
