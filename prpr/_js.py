...
async function findBin(project, path, create) {
  ...
  for (const part of parts) {
    ...
    if (!next) {
      ...
      runTransaction(project, `prpr: create bin ${part}`, (add) => {
...
SNIPPETS: dict[str, str] = {
    ...
    "sequence_rename": _s("""
        ...
        runTransaction(project, `prpr: rename sequence`, (add) => {
    ...
    "sequence_settings_set": _s("""
        ...
        if (Object.keys(s).length) {
          runTransaction(project, "prpr: sequence settings", (add) => {
    ...
    "marker_add": _s("""
        ...
        runTransaction(project, "prpr: add marker", (add) => {
        ...
        if (args.color_index !== undefined && args.color_index !== null) {
          ...
          if (created) {
            runTransaction(project, "prpr: marker color", (add) => {
    ...
    "marker_move": _s("""
        ...
        runTransaction(project, "prpr: move marker", (add) => {
    ...
    "color_label": _s("""
        ...
        if (args.set_index !== undefined && args.set_index !== null) {
          runTransaction(project, "prpr: color label", (add) => {
    ...
    "bin_rename": _s("""
        ...
        runTransaction(project, "prpr: rename bin", (add) => {
    ...
    "smart_bin_create": _s("""
        const project = await activeProject();
        const root = await project.getRootItem();
        runTransaction(project, "prpr: create smart bin", (add) => {
    ...
    "marker_remove": _s("""
        ...
        runTransaction(project, "prpr: remove marker", (add) => {
    ...
    "bin_delete": _s("""
        ...
        runTransaction(project, "prpr: delete bin", (add) => {
    ...
    "media_move": _s("""
        ...
        const moved = [];
        runTransaction(project, "prpr: move items", (add) => {
          for (const item of items) {
    ...
    "timeline_insert": _s("""
        ...
        runTransaction(project, "prpr: insert clip", (add) => {
          if (args.overwrite) {
    ...
    "timeline_remove_items": _s("""
        ...
        runTransaction(project, "prpr: remove items", (add) => {
    ...
    "clip_update": _s("""
        ...
        runTransaction(project, "prpr: update clips", (add) => {
    ...
    "transcript_import": _s("""
        ...
        runTransaction(project, "prpr: import transcript", (add) => {
    ...
    "subclip_create": _s("""
        ...
        runTransaction(project, "prpr: create subclip", (add) => {
    ...
    "sequence_in_out": _s("""
        ...
        if (args.in_seconds !== undefined || args.out_seconds !== undefined) {
          runTransaction(project, "prpr: set in/out", (add) => {
            if (args.in_seconds !== undefined && args.in_seconds !== null)
    ...
    "transition_add": _s("""
        ...
        runTransaction(project, "prpr: add transition", (add) => {
    ...
    "effect_add": _s("""
        ...
        for (const item of targets) {
          ...
          runTransaction(project, "prpr: add effect", (add) => {
    ...
    "param_set": _s("""
        ...
        runTransaction(project, "prpr: set param", (add) => {
    ...
    "metadata_set_xmp": _s("""
        ...
        const item = await findProjectItem(project, { name: args.name, path: args.path });
        if (!item) throw new Error(`Project item not found: ${args.name || args.path}`);
        runTransaction(project, "prpr: set XMP metadata", (add) => {
    ...
    "scratch_disks": _s("""
        ...
        if (args.set_type && args.set_path) {
          ...
          runTransaction(project, "prpr: scratch disks", (add) => {
    ...
    "ingest_settings": _s("""
        ...
        if (args.enabled !== undefined && args.enabled !== null) {
          ...
          runTransaction(project, "prpr: ingest", (add) => {
    ...
    "footage_interpretation": _s("""
        ...
        if (args.set) {
          ...
          runTransaction(project, "prpr: footage interpretation", (add) => {
    ...
    "track_update": _s("""
        ...
        if (args.set_name !== undefined && args.set_name !== null) {
          ...
          runTransaction(project, "prpr: rename track", (add) => {
    ...
    "sequence_clone": _s("""
        const project = await activeProject();
        const seq = await resolveSequence(project, args.sequence);
        runTransaction(project, "prpr: clone sequence", (add) => {
    ...
    "properties_set": _s("""
        ...
        runTransaction(project, "prpr: set property", (add) => {
